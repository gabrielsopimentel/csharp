namespace Vetores
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Qaul é a posição da Ingrid no vetor? " + Array.IndexOf(vetor03, "Ingrid"));
            Console.WriteLine("Qaul é a posição da Ingrid no vetor? " + Array.BinarySearch(vetor03, "Ingrid"));
