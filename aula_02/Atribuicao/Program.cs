namespace Atribuicao
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Digite um número inteiro para a variável x: ");
            x = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Digite um número inteiro para a variável y: ");
            y = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("Digite um número inteiro para a variável z: ");
